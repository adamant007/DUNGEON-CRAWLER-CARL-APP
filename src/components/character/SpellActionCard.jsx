  ...
  return (
    <ParchmentDialog title={s.name || "Spell"} onClose={onClose}>
      <div className="space-y-3">
        ...
        {s.detail && (
          <div className="border border-[var(--rule)] bg-[rgba(255,248,220,0.14)] px-3 py-2">
            <span className={`${LABEL} block mb-1`}>Mechanics</span>
            <p className="font-fell italic text-[13px] leading-snug text-[#24180f]">{s.detail}</p>
          </div>
        )}
